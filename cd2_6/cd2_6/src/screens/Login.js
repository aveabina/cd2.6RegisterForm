    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.form2}>
          <Button color='#00716F' title="Войти" onPress={() => Alert.alert("Вы вошли")}/>
          <Text style={styles.txt2}>Нет аккаунта?</Text>
          <Button color="#688B8A" title="Зарегестрироваться" onPress={() => this.props.navigation.navigate('Register')}/>
        </View>
      </View>
    )
  }
